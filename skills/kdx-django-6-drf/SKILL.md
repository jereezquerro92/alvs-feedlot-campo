...
metadata:
  ...
  pins_ssot: "docs/constitution/REQUIREMENTS.md"
---
...
**Pin SSOT:** project `docs/constitution/REQUIREMENTS.md` (template: `~/Templates/astro-drf-aws`). Metadata above mirrors that file — on re-pin, update REQUIREMENTS first, then this frontmatter. Prefer live PyPI / Django docs when versions drift mid-session. **Never** support Django ≤5.
...
| Pins | project `docs/constitution/REQUIREMENTS.md` |
