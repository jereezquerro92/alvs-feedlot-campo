...
Pin matches `docs/constitution/REQUIREMENTS.md`. Load **once** in the root layout (bundled, not CDN in production). Prefer attributes on markup over custom script.
