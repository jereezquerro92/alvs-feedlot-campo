...
Definitions at `docs/agents/orch-{low,medium,high}.md` in this repository (exposed via the `.claude/agents/` and `.agents/agents/` links) enforce tool restrictions. Workers CANNOT use tools outside their tier; this is not honor system.
