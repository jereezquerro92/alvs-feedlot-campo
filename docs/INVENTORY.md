...
| Route 53 A-alias `astro-drf-aws.grupoalvs.com` → `alvs-prod-alb` | zone `Z0653783OJDM9CPZYK6Z` | shared-attachment | 2026-07-12 — permanent routing per the owner's ruling on issue #33 (adr-50 rule 5): this template ships without CloudFront; private S3 + Django-issued presigned URLs is the media architecture. No longer "interim" |
