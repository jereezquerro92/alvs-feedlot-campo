...
Melt is the headless builder layer beneath the frontend's component stack. Stack context: [[FRONTEND]]; visual/component ownership: [[DESIGN-SYSTEM]]; rule: [[adr-52-frontend-and-design-system]]; version pin: [[REQUIREMENTS]].
...
- **shadcn-svelte** — the styled, vendored default ([[adr-52-frontend-and-design-system]] r4). Most work stays here.
...
This doc is the content home for this list; [[adr-52-frontend-and-design-system]] links here rather than restating it.
