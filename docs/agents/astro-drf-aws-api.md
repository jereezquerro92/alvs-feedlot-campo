...
- **→ astro-drf-aws-adr** when a change you're judging cannot be made valid under adr-51/adr-05 as written — the answer is a new ADR, never a local exception; or when the API change conflicts with any other active ADR.
