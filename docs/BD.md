...
This project's production database is **dedicated**, by explicit owner directive given in conversation on **2026-07-31** — see [[adr-49-feedlot-campo-dedicated-rds]] for the rule (adr-50 rule 5: infrastructure divergence requires its own ADR).
