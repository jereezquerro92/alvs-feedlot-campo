...
export const es = {
  ...
  // /profile/ AppearanceCard
  appearance_title: "Apariencia",
  appearance_packs: "Colecciones",
  appearance_packs_hint:
    "Aplicá un pack curado a ambos modos; después podés afinar colores. Guardar persiste el blob.",
  ...
  appearance_incomplete: "Definí canvas y puntos en ambos modos antes de guardar.",
  appearance_save_failed: "No se pudo guardar ({status})",
  appearance_save_failed_network: "No se pudo guardar",
