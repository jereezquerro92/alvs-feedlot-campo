...
<p class="text-sm text-muted-foreground">{t("demo_corner_nav_triangle_note")}</p>
<div class="relative h-24 w-24 overflow-hidden rounded-md border border-border [&_a]:!absolute">
  <CornerNavTriangle />
</div>
