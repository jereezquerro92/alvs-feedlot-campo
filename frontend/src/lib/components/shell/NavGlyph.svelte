...
<!-- Stroke glyphs for the enterprise NavDrawer. Presentation only — names are
     closed in nav.ts; copy stays in i18n. -->
<script lang="ts">
...
>
  ...
  {:else if name === "layers"}
    <path d="m12 3 9 5-9 5-9-5Z" /><path d="m3 12 9 5 9-5" /><path d="m3 17 9 5 9-5" />
  {/if}
</svg>
