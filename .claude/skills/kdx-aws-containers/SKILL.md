...
**Only stack:** ECS **Fargate** + **ECR** for the astro-drf-aws template on **ALVS** (`789650504128`, **us-east-1**). Doctrine: `docs/constitution/INFRASTRUCTURE.md`. Precedent: **sroa** on clusters `alvs-dev` / `alvs-prod`.
...
Push only via GHA OIDC (`gha-deploy-<env>`) — long-lived keys forbidden (`docs/constitution/INFRASTRUCTURE.md` CI/CD).
